          ...
          >
            ...
            >
              <form onSubmit={handleSubmit} className="flex w-full max-w-md items-center gap-2 relative group">
                <div className="absolute -inset-px bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg opacity-30 blur-md group-hover:opacity-50 transition duration-500" />
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {[
              ...
              >
                <div className="absolute -inset-px bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl opacity-0 group-hover:opacity-30 blur-md transition duration-500" />
